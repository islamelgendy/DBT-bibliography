...
data = [35, 31, 21,
        ...
        3, 3,  
        3, 13]
labels = ['Input', 'Test script', 'Feature',
          'Hybrid', 'Execution', 'Transition', 
          'Output', 'Coverage',  'GUI', 
          'Trigger', 'Semantic', 'Behavioural'
          'Path', 'Context', 
          'Test steps', 'Other']
...
fig.write_image("artefact-dist.pdf", format="pdf")
fig.show()
...
data = [29, 26, 11, 
        ...
        2, 2, 2, 1, 
        1, 1, 1]
labels = ['Input', 'Test script', 'Hybrid', 
          'Execution', 'Transition', 
          'Coverage', 'Feature', 'Output', 
          'GUI', 'Trigger', 'Semantic', 
          'Path', 'Context', 
          'Test steps', 'SPL configuration', 'Mutant', 
          'Requirements', 'Behavioural', 'Graph', 'Test report', 
          'Social', 'Function', 'Running time']